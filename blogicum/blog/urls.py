...
urlpatterns = [
    ...
    path('profile/<str:username>/edit_profile/', views.UserUpdateView.as_view(), name='edit_profile'),
    path('profile/<str:username>/', views.UserPageListView.as_view(), name='profile'),
