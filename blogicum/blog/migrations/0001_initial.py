# Generated by Django 3.2.16 on 2025-02-24 17:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime.now, verbose_name='Добавлено')),
                ('title', models.CharField(max_length=256, verbose_name='Заголовок')),
                ('descriptionsdfsf', models.TextField(verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=True, help_text='Снимите галочку, чтобы скрыть публикацию.', verbose_name='Опубликовано')),
                ('created_at', models.DateTimeField(default=datetime.datetime.now, verbose_name='Добавлено')),
                ('title', models.CharField(default='sad', max_length=256, verbose_name='Заголовок')),
                ('text', models.TextField(default='23', verbose_name='Текст')),
                ('pub_date', models.DateTimeField(default=datetime.datetime.now, help_text='Если установить дату и время в будущем — можно делать отложенные публикации.', verbose_name='Дата и время публикации')),
